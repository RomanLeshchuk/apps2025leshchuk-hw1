...
public class TemperatureSeriesAnalysisTest {
    ...
    public void testAddTempsInvalid() {
        TemperatureSeriesAnalysis seriesAnalysis = new TemperatureSeriesAnalysis();
        seriesAnalysis.addTemps(1.0, TemperatureSeriesAnalysis.LOWEST_TEMP - 1.0, 3.0);
    }
    ...
    public void testAddTempsInvalidNoChange() {
        ...
        try {
            seriesAnalysis.addTemps(3.0, TemperatureSeriesAnalysis.LOWEST_TEMP - 1.0);
    ...
    public void testConstructorWithInvalidTemp() {
        double[] temperatureSeries = {1.0, TemperatureSeriesAnalysis.LOWEST_TEMP - 1.0};
        new TemperatureSeriesAnalysis(temperatureSeries);
    }

    @Test
    public void testConstructorWithBoundaryTemp() {
        double[] temperatureSeries = {TemperatureSeriesAnalysis.LOWEST_TEMP};
        TemperatureSeriesAnalysis seriesAnalysis = new TemperatureSeriesAnalysis(temperatureSeries);
        assertEquals(TemperatureSeriesAnalysis.LOWEST_TEMP, seriesAnalysis.min(), DELTA);
    }
}